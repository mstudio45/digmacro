...
<p align="center">
    ...
    <i><a href="/CHANGELOGS.md">Changelogs</a> | <a href="https://discord.gg/hrryPU6cqh" target="_blank">Discord Server</a></i>
</p>
...
| **MacBook with Intel CPU**       | ✅ Full Support   | macOS Catalina 10.15+, 8GB RAM or more                                                  | MacBook Pro Intel i7                        | Due to Intel CPU performance on MacBooks, the macro **will only work with Roblox locked at 60 FPS and with the lowest graphics settings possible**       |
...
- **Macro is missing clicks or not working well:**
  - The macro’s speed can be affected by several factors:
    1) CPU performance, RAM Usage, Background Applications
    2) Roblox FPS
